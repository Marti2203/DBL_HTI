...
%% Paper title.
\title{Visualisation of Eye Tracking Data}
...
%% Abstract section.
\abstract{Abstract should contain: short introduction, short description and short conclusion of the whole project.%
} % end of abstract

%% Keywords that describe your work. Will show as 'Index Terms' in journal
%% please capitalize first letter and insert punctuation after last keyword
\keywords{keywords inserted here}
...
\teaser{
  ...
  \caption{Teaser figure caption. Note that the teaser may not be wider than the abstract block.}
  \label{fig:teaser}
}
...
\paragraph{template set-up}
The numbered sections of the report are the actual template that we (the group) need to fill in and write. The rest of the text below the set-up, are more examples that can be helpful when writing the report as it needs to be done in a very specific way. 

In the introduction, the project needs to be introduced. In needs to be explained what the project should contain, the demands the customer made, what SCRUM is, etc etc

\section{Related work}
In this section, an overview of related projects needs to be given. It needs to be explained what those websites or tools do and how or not that differs from our project. 

\section{Data model and Data processing}
Here, the data set structure and how it is changed and manipulated to work with it needs to be explained. 
\\
\\
Subsections may be necessary here.

\section{The visualisation tool}
In this section we present the actual visualization application that
we have developed. 
\subsection{Design Decisions}
Here a list of criteria is given
\subsection{Graphical User Interface}
Explain what the user can do basically. So, this describes the different options for the user. 
\subsection{Visualisation Techniques and Algorithms}
Here the 4 different visualisations are explained.
\subsection{Interaction techniques}

\section{Application example}
Give some concrete examples of the visualisations and explain some of the outcomes globally.

\section{Discussion and limitations}
In this section improvements and limitations need to be discussed. 

\section{Conclusion and Future work}
Give a summary of the project and further implementations.
\\
\\
\\
\\
