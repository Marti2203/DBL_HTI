...
"""
    def main(self):
        index = "4" # This number will be made dynamic, then you will need to query the last row of the Filename table
        FileName = "File"+index
...
"""
    def FilenameUpdater(self, Filename):
        newEntry = Filename(File=FileName)
